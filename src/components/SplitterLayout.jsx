  ...
  render() {
    ...
    for (let i = 0; i < children.length; ++i) {
      ...
      wrappedChildren.push(
        ...
        <Pane vertical={this.props.vertical} percentage={this.props.percentage} primary={primary} size={size} type={this.props.isMap}>
          {children[i]}
      {this.props.isMap && <span className="left-divider" onClick={this.clickHandlers} ></span> }
      {this.props.isMap && <span className="bottom-divider"></span> }
      {this.props.isMap && <span className="top-divider"></span> }
      {this.props.isMap && <span className="right-divider"></span> }
        </Pane>
      );
    }
